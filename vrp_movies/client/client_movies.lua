...
-- Check if the cinema is open or closed.
          if hour < openingHour or hour > closingHour then
			helpDisplay("The movie is broadcasting between 1am and 22pm.", 0)
          else
			helpDisplay("Press ~INPUT_CONTEXT~ to enter the movie theater.", 0)
...
AddEventHandler("vrp_cinema:movie", function (data)
	...
	AddTextComponentString("Press the ~ r ~ E ~ w ~ button to exit the theater.")
